...
[![AI Powered](https://img.shields.io/badge/AI-双引擎架构-green?logo=openai&logoColor=white)](https://platform.openai.com/)
[![Multi Account](https://img.shields.io/badge/多账号-支持-orange?logo=account&logoColor=white)](#)
[![Dual Mode](https://img.shields.io/badge/双模式-买家+卖家-purple?logo=swap&logoColor=white)](#)
...
<div align="center">
  <table>
    ...
    <tr>
      <td><img src="./images/demo1.png" width="350" alt="卖家客服"></td>
      <td><img src="./images/demo2.png" width="350" alt="买家议价"></td>
    </tr>
    <tr>
...
<div align="center">
  <table>
    ...
    <tr>
      <td><img src="./images/demo3.png" width="350" alt="议价策略"></td>
      <td><img src="./images/webImg.png" width="350" alt="管理界面"></td>
    </tr>
    <tr>
...
在 `.env` 文件中配置以下参数。模型接入有两种方式：

- 默认方式：复用本机 OpenClaw，直接走 `openai-codex/gpt-5.4`，不需要单独 API key
- 可选方式：显式填写第三方 OpenAI 兼容接口的 `API_KEY` / `MODEL_BASE_URL`
...
> 💡 **提示**: 不配置扣子也能正常使用，买家AI会自动降级到本机 OpenClaw / 第三方模型配置
...
当前 `www.goofish.com/publish` 已适配新版发布页，默认遵循以下规则：

- 文案先做合规改写，不做缩写或变体避审
- 描述区第一行即标题，正文统一整理成“适合需求 / 交付内容 / 服务亮点 / 下单前请发”
- 默认只上传 1 张与主题相关的封面图
- 封面图会尽早上传，和后续字段填写并行，减少发布尾部等待
- 自动点击发布前，会等待图片上传接口静默，避免“按钮已亮但未真正发出发布请求”

### 可视化一键发布

```bash
./live_publish.sh --title "AI文案撰写支持｜需求明确｜交付清晰" --description "想把内容需求讲清楚、交付更省心，可以直接拍下沟通。"
```

### 相关脚本

- `live_publish.sh`: 仓库内一键可视化发布入口
- `xianyu_auto_publish.py`: 基础发布逻辑
- `xianyu_smart_publish.py`: 复用新版发布逻辑的增强版入口
- `live_prepublish_debug.py`: 可视化联调与自动点击发布
- `xianyu_publish_content.py`: 文案合规改写、结构整理、单图封面选择
...
<img src="./images/webImg.png" width="250" alt="配置首页"></
2. **点击"添加账号"**
3. **填写账号信息**:
   - 账号名称: 便于识别的名字
   - 用户ID: 闲鱼用户ID
...
<div align="center">
  <table>
    ...
    <tr>
      <td><img src="./images/wx_group6-1.jpg" width="250" alt="交流群"></td>
      <td><img src="./images/wx_group2.jpg" width="250" alt="技术群"></td>
    </tr>
    <tr>
...
<div align="center">
  <table>
    ...
    <tr>
      <td><img src="./images/wechat_pay.jpg" width="300" alt="微信赞赏"></td>
      <td><img src="./images/alipay.jpg" width="300" alt="支付宝"></td>
    </tr>
  </table>
</div>
